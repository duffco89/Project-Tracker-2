...
class ProjectSerializer(serializers.HyperlinkedModelSerializer):
    ...
    project_type = serializers.CharField(source='project_type.project_type',
                                         read_only=True)
    ...
    class Meta:
        model = Project
        lookup_field = 'slug'
        fields = ('year', 'prj_cd', 'slug', 'prj_nm', 'prj_date0',
                  'prj_date1', 'project_type', 'prj_ldr', 'comment',
                  'sample_points')
