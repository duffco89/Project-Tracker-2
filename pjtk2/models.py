...
def get_associated_file_upload_path(instance, filename):
    ...
    '''
    #from http://hustoknow.blogspot.ca/2010/08/try-me-out.html
    filename = os.path.basename(filename)
    return os.path.join('associated_files', instance.project.slug, filename)

class AssociatedFile(models.Model):
    '''class for associated files.  Unlike reports, an associated file can
    only be linked to a single project and isn't associated with a milestone.
    '''
