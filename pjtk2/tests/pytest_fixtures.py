...
def joe_user(db):
    ...
    """
    password = "Abcd1234"
    joe = UserFactory.create(
        username="jblow", first_name="Joe", last_name="Blow", password=password
    )
    return joe
...
def dba(db):
    ...
    kramer = DBA_Factory.create(
        username="ckramer", first_name="cozmo", last_name="kramer", password=password
    )
    return kramer
