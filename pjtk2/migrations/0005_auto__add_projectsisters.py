...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectSisters'
        db.create_table(u'pjtk2_projectsisters', (
        ...
        db.send_create_signal(u'pjtk2', ['ProjectSisters'])


    def backwards(self, orm):
        # Deleting model 'ProjectSisters'
        db.delete_table(u'pjtk2_projectsisters')
