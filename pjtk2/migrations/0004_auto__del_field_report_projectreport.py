...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report.projectreport'
        db.delete_column(u'pjtk2_report', 'projectreport_id')

        # Adding M2M table for field projectreport on 'Report'
        db.create_table(u'pjtk2_report_projectreport', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('report', models.ForeignKey(orm[u'pjtk2.report'], null=False)),
            ('projectreports', models.ForeignKey(orm[u'pjtk2.projectreports'], null=False))
        ))
        db.create_unique(u'pjtk2_report_projectreport', ['report_id', 'projectreports_id'])


    def backwards(self, orm):
        # Adding field 'Report.projectreport'
        db.add_column(u'pjtk2_report', 'projectreport',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['pjtk2.ProjectReports']),
                      keep_default=False)

        # Removing M2M table for field projectreport on 'Report'
        db.delete_table('pjtk2_report_projectreport')
