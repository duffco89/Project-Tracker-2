...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Milestone.order'
        db.add_column('pjtk2_milestone', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Milestone.category'
        db.alter_column('pjtk2_milestone', 'category', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Milestone.label'
        db.alter_column('pjtk2_milestone', 'label', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting field 'Milestone.order'
        db.delete_column('pjtk2_milestone', 'order')


        # Changing field 'Milestone.category'
        db.alter_column('pjtk2_milestone', 'category', self.gf('django.db.models.fields.TextField')(max_length=30))

        # Changing field 'Milestone.label'
        db.alter_column('pjtk2_milestone', 'label', self.gf('django.db.models.fields.TextField')(max_length=30))
