...
class ProjectBookmarkingTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.project1 = ProjectFactory(
            prj_cd="LHA_IA12_222", prj_ldr=self.user, owner=self.user
        )
    ...
    def test_bookmarking_view(self):
        ...
        response = self.client.get(
            reverse("Bookmark_Project", args=(self.project1.slug,)), follow=True
        )
        ...
        prj_ldr = "{0} {1}".format(
            self.project1.prj_ldr.first_name, self.project1.prj_ldr.last_name
        )
    ...
    def test_unbookmarking_confirm_view(self):
        ...
        response = self.client.get(
            reverse("Unbookmark_Project", args=(self.project1.slug,)), follow=True
        )
