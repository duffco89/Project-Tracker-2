...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.ProjectType'
        db.alter_column(u'pjtk2_project', 'ProjectType_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pjtk2.TL_ProjType'], null=True))

        # Changing field 'Project.MasterDatabase'
        db.alter_column(u'pjtk2_project', 'MasterDatabase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pjtk2.TL_Database'], null=True))

    def backwards(self, orm):

        # Changing field 'Project.ProjectType'
        db.alter_column(u'pjtk2_project', 'ProjectType_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pjtk2.TL_ProjType']))

        # Changing field 'Project.MasterDatabase'
        db.alter_column(u'pjtk2_project', 'MasterDatabase_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pjtk2.TL_Database']))
    ...
    models = {
        ...
        u'pjtk2.project': {
            ...
            'Funding': ('django.db.models.fields.CharField', [], {'default': "'spa'", 'max_length': '30'}),
            'Lake': ('django.db.models.fields.CharField', [], {'default': "'LH'", 'max_length': '30'}),
            'MasterDatabase': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pjtk2.TL_Database']", 'null': 'True', 'blank': 'True'}),
            ...
            'ProjectType': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pjtk2.TL_ProjType']", 'null': 'True', 'blank': 'True'}),
