...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pjtk2_project', 'Active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Project.Funding'
        db.add_column(u'pjtk2_project', 'Funding',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)

        # Adding field 'Project.Lake'
        db.add_column(u'pjtk2_project', 'Lake',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=30),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pjtk2_project', 'Active')

        # Deleting field 'Project.Funding'
        db.delete_column(u'pjtk2_project', 'Funding')

        # Deleting field 'Project.Lake'
        db.delete_column(u'pjtk2_project', 'Lake')
