...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Family'
        db.create_table(u'pjtk2_family', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'pjtk2', ['Family'])


        # Renaming column for 'ProjectSisters.family' to match new field type.
        db.rename_column(u'pjtk2_projectsisters', 'family', 'family_id')
        # Changing field 'ProjectSisters.family'
        db.alter_column(u'pjtk2_projectsisters', 'family_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pjtk2.Family']))
        # Adding index on 'ProjectSisters', fields ['family']
        db.create_index(u'pjtk2_projectsisters', ['family_id'])


    def backwards(self, orm):
        # Removing index on 'ProjectSisters', fields ['family']
        db.delete_index(u'pjtk2_projectsisters', ['family_id'])

        # Deleting model 'Family'
        db.delete_table(u'pjtk2_family')


        # Renaming column for 'ProjectSisters.family' to match new field type.
        db.rename_column(u'pjtk2_projectsisters', 'family_id', 'family')
        # Changing field 'ProjectSisters.family'
        db.alter_column(u'pjtk2_projectsisters', 'family', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'pjtk2.projectsisters': {
            'Meta': {'object_name': 'ProjectSisters'},
