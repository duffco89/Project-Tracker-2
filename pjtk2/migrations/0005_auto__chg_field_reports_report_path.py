...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reports.report_path'
        db.alter_column('pjtk2_reports', 'report_path', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Reports.report_path'
        db.alter_column('pjtk2_reports', 'report_path', self.gf('django.db.models.fields.CharField')(max_length=300))
