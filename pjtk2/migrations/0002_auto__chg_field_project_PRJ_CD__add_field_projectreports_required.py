...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.PRJ_CD'
        db.alter_column(u'pjtk2_project', 'PRJ_CD', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12))
        # Adding field 'ProjectReports.required'
        db.add_column(u'pjtk2_projectreports', 'required',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.PRJ_CD'
        db.alter_column(u'pjtk2_project', 'PRJ_CD', self.gf('django.db.models.fields.CharField')(max_length=13, unique=True))
        # Deleting field 'ProjectReports.required'
        db.delete_column(u'pjtk2_projectreports', 'required')
    ...
    models = {
        ...
        u'pjtk2.report': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'projectreport': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pjtk2.ProjectReports']"}),
