...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="projectmilestones",
                        to="pjtk2.Milestone",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "Project Protocol"},
        ),
        migrations.CreateModel(
            name="ProjectPolygon",
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "Project Funding Source"},
        ),
        migrations.AddField(
            model_name="project",
            name="project_type",
        ...
        migrations.AlterUniqueTogether(
            name="projectmilestones", unique_together={("project", "milestone")}
        ),
        migrations.AlterUniqueTogether(
            name="projectfunding", unique_together={("project", "source")}
        ),
        migrations.AddIndex(
            model_name="project",
            index=django.contrib.postgres.indexes.GinIndex(
                fields=["content_search"], name="pjtk2_proje_content_188c26_gin"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="messages2users", unique_together={("user", "message")}
        ),
