...
MASTERS = {
    "offshore": {
        "path": "Z:/Data Warehouse/Assessment/Index/Offshore/IA_OFFSHORE.accdb",
    ...
    "nearshore": {
        "path": "Z:/Data Warehouse/Assessment/Index/Nearshore/IA_NEARSHORE.accdb",
        "table": "IA121",
        "sam": "SAM",
        "ddlat": "DD_LAT",
        "ddlon": "DD_LON",
    ...
    "smallfish": {
        "path": (
            "Z:/Data Warehouse/Assessment/Index/Nearshore/"
            + "Small_Fish/COA_Nearshore_Smallfish.accdb"
        ),
        "table": "121",
        "sam": "SAM",
        "ddlat": "dd_lat",
    ...
    "fishway": {
        "path": "Z:\Data Warehouse\Assessment\Fishway\Fishway_Master.accdb",
        "table": "IM_121",
        "sam": "SAM",
        "ddlat": "DD_LAT",
        "ddlon": "DD_LON",
    ...
    "sturgeon": {
        ...
        #        'Sturgeon/Sturgeon Master.accdb'),
        #'path': ('Z:/Data Warehouse/Derived Datasets/UNIT PROJECTS/Sturgeon/' +
        #         'SturgeonMasterpriortoLCMupdate01APR2011/Sturgeon Master.accdb'),
        "path": (
            "Z:/Data Warehouse/Assessment/Index/Sturgeon/" + "SturgeonMaster.accdb"
        ),
    ...
    "comcatch": {
        "path": (
            "Z:/Data Warehouse/Commercial Fisheries/Catch Sampling/" + "CF_Master.accdb"
        ),
        "table": "Final_FN121",
        "sam": "SAM",
        "ddlat": "DD_LAT",
    ...
    "stocking": {
        "path": (
            "Y:/Information Resources/Dataset_Utilities/FS_Maker/" + "FS_Master.accdb"
        ),
        "table": "FS_Events",
        "sam": "EVENT",
        "ddlat": "DD_LAT",
    ...
    "creel": {
        "path": (
            "Z:/Data Warehouse/Recreational Fisheries/Creel/SC/"
            + "CREESYS4.1_jspeers/Creesys 4.1.accdb"
        ),
        "table": "FN121",
        "sam": "SAM",
        "ddlat": "DD_LAT",
    ...
    "sportfish": {
        "path": (
            "Z:/Data Warehouse/Recreational Fisheries/Angler Diary/Sf/"
            + "SF_MASTER.accdb"
        ),
        "table": "FN121",
        "sam": "SAM",
    ...
    "benthic": {
        "path": (
            "Z:/Data Warehouse/Derived Datasets/UNIT PROJECTS/Benthics/"
            + "Lake Huron Benthics.mdb"
        ),
        #'path':'Y:/File Transfer/Lake Huron Benthics.accdb',
        "table": "LH_benthics",
        "sam": "Station ID",
        "ddlat": "DD Latitude",
        "ddlon": "DD Longitude",
...
for db in MASTERS.keys():
    ...
    constr = r"DRIVER={{Microsoft Access Driver (*.mdb, *.accdb)}};DBQ={0}"
    ...
    sql = build_sql(
        dbase["table"], dbase["sam"], dbase["ddlat"], dbase["ddlon"], dbase["groupby"]
    )
    mdbcur.execute(sql)
    result = mdbcur.fetchall()
    print("There were {0} records found in {1}".format(len(result), db))
...
constr = "host={0} dbname={1} user={2} password='django'".format(
    PG_HOST, PG_DB, PG_USER
)
...
args = [
    {"dbase": x[0], "prj_cd": x[1], "sam": x[2], "ddlat": x[3], "ddlon": x[4]}
