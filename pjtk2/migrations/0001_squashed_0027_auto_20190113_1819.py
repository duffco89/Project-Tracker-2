...
class Migration(migrations.Migration):
    ...
    replaces = [('pjtk2', '0001_initial'), ('pjtk2', '0002_auto_20171117_0847'), ('pjtk2', '0003_auto_20171117_0852'), ('pjtk2', '0004_auto_20171117_0854'), ('pjtk2', '0005_auto_20171129_1603'), ('pjtk2', '0006_auto_20171205_1127'), ('pjtk2', '0007_auto_20171205_1202'), ('pjtk2', '0008_auto_20171205_1203'), ('pjtk2', '0009_auto_20171205_1203'), ('pjtk2', '0010_auto_20180629_1024'), ('pjtk2', '0011_auto_20180629_1031'), ('pjtk2', '0012_auto_20180629_1050'), ('pjtk2', '0013_auto_20180629_1105'), ('pjtk2', '0014_auto_20180705_1704'), ('pjtk2', '0015_auto_20180710_1145'), ('pjtk2', '0016_auto_20180711_1143'), ('pjtk2', '0017_auto_20180712_0928'), ('pjtk2', '0018_auto_20180712_1202'), ('pjtk2', '0019_auto_20180712_1411'), ('pjtk2', '0020_auto_20181009_1133'), ('pjtk2', '0021_auto_20181011_0934'), ('pjtk2', '0022_auto_20181011_1155'), ('pjtk2', '0023_auto_20181012_0915'), ('pjtk2', '0024_auto_20190113_1724'), ('pjtk2', '0025_auto_20190113_1818'), ('pjtk2', '0026_auto_20190113_1818'), ('pjtk2', '0027_auto_20190113_1819')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('employee', 'Employee'), ('manager', 'Manager'), ('dba', 'DBA')], default='Employee', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Family',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('actionrequired', 'Action Required'), ('info', 'Info')], default='info', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Messages2Users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Core', 'core'), ('Custom', 'custom'), ('Suggested', 'suggested')], default='Custom', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.CharField(blank=True, editable=False, max_length=4, verbose_name='Year')),
                ...
                ('funding', models.CharField(choices=[('spa', 'SPA'), ('other', 'other'), ('coa', 'COA')], default='spa', max_length=30, verbose_name='Funding Source')),
                ...
                ('lake', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='pjtk2.Lake')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('milestone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pjtk2.Milestone')),
        ...
        migrations.AddField(
            model_name='employee',
            name='supervisor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pjtk2.Employee'),
        ),
        migrations.AddField(
            model_name='employee',
            name='user',
        ...
        migrations.AddField(
            model_name='bookmark',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pjtk2.Project'),
        ),
        migrations.AddField(
            model_name='bookmark',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_bookmark', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
