...
from: https://github.com/DrMeers/pycon_2012_testing_demo/blob/master/testing_demo/__init__.py
"""
...
"""
        ...
        try:
            ...
            logger.warning('Searched content: """{}"""'.format(response.content))
            raise
    ...
    def create_user(self, username, email=None, password=None, super=False):
        ...
        method = User.objects.create_superuser if super else User.objects.create_user
    ...
    def _test_urls(self, url_attributes):
        ...
        for url, attributes in url_attributes:
            ...
            if "status_code" in attributes:
                self.assertEqual(response.status_code, attributes["status_code"])
