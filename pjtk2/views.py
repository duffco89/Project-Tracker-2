...
def update_milestones(form_ms, milestones):
    ...
    project will be updated with a time stamp, events associated with this project that
    are not in form_ms will have their time stamp cleared.

    milestones - queryset of milestones associated with a project generated by \n
        proj.get_milestones()
    forms_ms - list of proejctmilestone id numbers generated from
