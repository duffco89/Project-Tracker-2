...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pjtk2_bookmark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pjtk2.Project'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_bookmark', to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'pjtk2', ['Bookmark'])

        # Adding unique constraint on 'Milestone', fields ['label']
        db.create_unique(u'pjtk2_milestone', ['label'])


    def backwards(self, orm):
        # Removing unique constraint on 'Milestone', fields ['label']
        db.delete_unique(u'pjtk2_milestone', ['label'])

        # Deleting model 'Bookmark'
        db.delete_table(u'pjtk2_bookmark')
